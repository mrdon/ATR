...
{
    /**
     * Renders the template to the writer with a default context providing an {@code I18nResolver} and 
     * {@code WebResourceManager}. 
     * 
     ...
     * {@code I18nResolver} and {@code WebResourceManager}.
     * 
     * @param templateName file name of the template to render
    ...
    /**
     * Renders the {@code fragment} using the given context and adding {@code I18nResolver} and 
     * {@code WebResourceManager}.
     *  
